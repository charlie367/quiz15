...
public interface QuizDao extends JpaRepository<Quiz, Integer> {
	...
	public void insert(String name, String description, LocalDate startDate, LocalDate endDate,//
			boolean published);
	...
	public int update( int id,String name, String description, LocalDate startDate, LocalDate endDate,//
			boolean published);
	...
	// is_published is true: is 只能用在 boolean 值得欄位，is 也可以替換成等於(=)
	@Query(value = "select * from quiz where name like %?1% and start_date >= ?2" //
